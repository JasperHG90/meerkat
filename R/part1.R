...
#' Calculate a t-test between two variables
#'
#' @param x a numeric vector
#' @param y a numeric vector
#' @param variance_equal boolean (TRUE/FALSE) indicating if variance of x and y are equal or not.
#'
#' @author Jasper Ginn
#'
...
print.t_test <- function(x) {
  ...
  msg <- paste0(# Print whether test is equal/unequal variances
    ...
    ifelse(x$inputs$variance_equal,
           paste0("\n", "------------------------", "\n",
                  "Pooled variance: ", round(x$summary_statistics$pooled_variance, digits=2)),
           ""),
    "\n\n",
...
#
# @return
pooled_variance <- function(var_x,
                            var_y,
                            n_x,
                            n_y) {
